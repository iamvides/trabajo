...
public class Registro { //Definimos la clase
    ...
    public static void validarNombre(String nombre) throws Exception { //Valida el ingreso de datos y lanza la excepcion
        if (nombre == null || nombre.trim().isEmpty()) {
            throw new Exception("El nombre no puede estar vacío.");
        }
    }

    public static void validarEdad(int edad) throws Exception { //Valida el ingreso de datos y lanza la excepcion 
        if (edad <= 0) {
            throw new Exception("La edad debe ser un número positivo.");
        }
    }

    public static void validarCorreo(String correo) throws Exception { //Valida el ingreso de datos y lanza la excepcion
